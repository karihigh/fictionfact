...
//var textTyped = ['Bibbidi Bobbidi Boo', 'Four buried alive for following witchcraft'];
...
function setup() {
  ...
  textTyped = [spells.spells[int(random(indexone))],
    articles.articles[int(random(indextwo))].Title];
...
function createFontPaths(textTyped, font, attractorStatus){
  ...
  path = g.resampleByLength(path, 8);
